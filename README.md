...
StoreWell opens outside at the upgraded September storage property, with animated characters, uniforms, walking routes, whole-door status alerts and staff rounds. See RECOVERY.md for the recovered source and custom character files. Command Center opens the spacious white-lit bridge, with space visible through the windows and a clear central aisle. Use the joystick to walk and turn, or drag the room to look around. Main screen opens the working dashboard; Bridge restores the room view. On phones the same live controls use a readable, scrolling layout.
